...
**Реализовано сейчас:**
  ...
  + Два плейлиста: ОБЩИЙ и ИЗБРАННОЕ. (Второй плейлист пока с минимальными фишками.)
  ...
  + Настройка конфигурации Радиолы и переопределение пинов ESP32 производится через через задачу `Run Menuconfig -> Настройка ESP32-Радиолы` из среды PlatformIO.
  ...
  + Полное управление всеми функциями TDA7313 через web-интерфейс.
 ...
 **TODO (перспектива):**
  ...
  + Создать приложение пол андроид для управления Радиолой.
  + etc...
